...
func doInstallHook(r *git.Runner) error {
	...
	fmt.Fprintln(os.Stderr, "Configure groups (global, one-time):")
	fmt.Fprintln(os.Stderr, "")
	fmt.Fprintln(os.Stderr, "  git config --global hooks.ai-exporter.groups.work.url https://your-dashboard.com/api/collect")
	fmt.Fprintln(os.Stderr, "  git config --global hooks.ai-exporter.groups.work.token your-api-token")
	fmt.Fprintln(os.Stderr, "")
	fmt.Fprintln(os.Stderr, "Enable for this project (per repo):")
	fmt.Fprintln(os.Stderr, "")
	fmt.Fprintln(os.Stderr, "  git config hooks.ai-exporter.group work")
	fmt.Fprintln(os.Stderr, "")
	fmt.Fprintln(os.Stderr, "Or override completely (per repo):")
	fmt.Fprintln(os.Stderr, "")
